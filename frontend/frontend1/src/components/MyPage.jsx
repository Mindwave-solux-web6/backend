  ...
  const fetchData = async (dateString) => {
    try {
      const diaryResponse = await axios.get(
        `http://127.0.0.1:8080/api/diary-and-letter/diary?date=${dateString}`
      );
      const letterResponse = await axios.get(
        `http://127.0.0.1:8080/api/diary-and-letter/letter?date=${dateString}`
      );
            ...
            <div className="show">
              ...
              <div className="show-d">
                ...
                <div className="showcontent mb-2">
                  제목: {selectedData.diaryTitle}
                </div>
                <div className="showcontent">{selectedData.diaryContent}</div>
                <div className="b3">
                  <button
                    className="btn btn-secondary btn-xl2 m-2"
                    id="edit"
                    type="submit"
                  >
                    수정
                  ...
                  <button
                    className="btn btn-primary btn-xl2 m-2"
                    id="save"
                    type="submit"
                  >
                    저장
                  ...
                  <button
                    className="btn btn-danger btn-xl2 m-2"
                    id="delete"
                    type="submit"
                  >
                    삭제
